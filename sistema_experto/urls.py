...
urlpatterns = [
    ...
    path(
        "login/usuario/",
        views.login_usuario_automatico,
        name="login_usuario_automatico",
    ),
    ...
    path(
        "editar-hecho-backward/<int:id>/",
        views.editar_hecho_backward,
        name="editar_hecho_backward",
    ),
    path(
        "editar-regla-backward/<int:id>/",
        views.editar_regla_backward,
        name="editar_regla_backward",
    ),
    path(
        "administrar-backward/", views.administrar_backward, name="administrar_backward"
    ),
    path(
        "eliminar-hecho-backward/<str:desc>/",
        views.eliminar_hecho_backward,
        name="eliminar_hecho_backward",
    ),
    path(
        "eliminar-regla-backward/<str:condicion>/<str:conclusion>/",
        views.eliminar_regla_backward,
        name="eliminar_regla_backward",
    ),
]
